...
![AgentTap demo](https://raw.githubusercontent.com/HongguangLi/agenttap/main/promo/agenttap-demo.gif)

*Dashboard, traces (timeline · tree · mind-map), observations, sessions & users — all local.*
